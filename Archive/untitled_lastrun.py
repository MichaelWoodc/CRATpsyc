...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath="C:\\Users\\Michael\\OneDrive - Georgia Southern University\\Virginia Wickline's files - crat\\GITHUB\\CRATpsyc\\untitled_lastrun.py",
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions("C:/Users/Michael/OneDrive - Georgia Southern University/Virginia Wickline's files - crat/GITHUB/CRATpsyc/practice_trials.xlsx"), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if tThisFlip > Trial_1.maxDuration-frameTolerance:
                Trial_1.maxDurationReached = True
                continueRoutine = False
        ...
        Answer_Screen.maxDuration = None
        # keep track of which components have finished
        ...
        while continueRoutine:
            ...
            if textbox_3.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
